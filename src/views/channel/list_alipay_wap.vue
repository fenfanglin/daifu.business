<template>
	...
	<div v-else class="app-container">
		...
		<el-row :gutter="10" class="mb20">
			<el-col :span="1.5">
				<a href="https://jqkstore.oss-cn-hongkong.aliyuncs.com/document/alipay_wap.zip" class="download_document">
					下载教程
				</a>
			</el-col>
		</el-row>
...
export default {
	...
	methods: {
		...
		autoReload() {
			...
			let auto_reload = that.cookies.get('auto_reload_alipay_wap')
			if (auto_reload) {
		...
		handleAutoReloadChange(command) {
			...
			this.cookies.set('auto_reload_alipay_wap', JSON.stringify(auto_reload))
