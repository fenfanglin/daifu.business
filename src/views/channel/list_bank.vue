<template>
	<div v-if="check_channel == false" class="app-container">
		...
		<!-- <div class="panel-group-message">
			<div class="card-panel">
				<div class="card-panel-description">
					<div class="card-panel-title">通道未开启</div>
					<div class="card-panel-text">请联系后台管理员开启通道</div>
				</div>
			</div>
		</div> -->
	</div>
	<div v-else class="app-container">
		...
		<el-row :gutter="10" class="mb20">
			<el-col :span="1.5">
				<el-button type="primary" icon="el-icon-plus" @click="handleAdd" v-hasPermi="['channel_web_bank:save:add']">新增</el-button>
			</el-col>
			<!-- <el-col :span="1.5">
				<el-button type="danger" icon="el-icon-delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['channel_web_bank:delete']">删除</el-button>
			</el-col> -->
			<el-col :span="1.5">
				<el-button type="primary" icon="el-icon-download" @click="handleExport" v-hasPermi="['channel_web_bank:export']">导出</el-button>
			</el-col>
		</el-row>
		
		<el-row :gutter="10" class="mb20">
			<el-col :span="1.5">
				<a href="https://jqkstore.oss-cn-hongkong.aliyuncs.com/document/bank.zip" class="download_document">
					下载教程
				</a>
			</el-col>
		</el-row>
		...
		<el-table ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list" @selection-change="handleSelectionChange">
			...
			<el-table-column label="开户名" prop="name" :show-overflow-tooltip="true" width="90" />
			<el-table-column label="银行信息" :show-overflow-tooltip="true" width="240">
			...
			<el-table-column label="银行卡余额" width="100">
				<template slot-scope="scope">
			...
			<el-table-column label="操作" width="180" fixed="right">
				<template slot-scope="scope">
					<el-button type="primary" class="tb-button" icon="el-icon-edit" @click="handleEdit(scope.row)" v-hasPermi="['channel_web_bank:save:edit']" plain>编辑</el-button>
					<el-button type="danger" class="tb-button" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['channel_web_bank:delete']" plain>删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog :title="title" :visible.sync="open" width="600px" append-to-body :close-on-click-modal="false">
			<el-form ref="form" :model="form" :rules="rules" label-width="100px">
				<el-row>
					...
					<el-form-item label="引导操作">
						<el-input v-model="form.remark2" maxlength="100" show-word-limit autocomplete="off" :disabled="user.type == 2" />
					</el-form-item>
...
<script>
export default {
	name: "channel_list_bank", // 路由上 '/' 换成 '_'
	data() {
		return {
			user: {},
			channel_id: 101,
	...
	methods: {
		...
		handleExport() {
			...
			that.exportExcel("channel_web_bank/export", this.queryParams, "管理员").then(res => {
		...
		autoReload() {
			...
			let auto_reload = that.cookies.get('auto_reload_bank')
			if (auto_reload) {
		...
		handleAutoReloadChange(command) {
			...
			this.cookies.set('auto_reload_bank', JSON.stringify(auto_reload))
