<template>
	<div class="app-container">
		<el-row :gutter="10" class="mb20">
			<el-col :span="1.5">
				<el-button type="primary" icon="el-icon-plus" @click="handleAdd" v-hasPermi="['channel_product:save2:add']">新增</el-button>
			</el-col>
		</el-row>

		<el-table ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list" @selection-change="handleSelectionChange">
			<el-table-column label="人均金额" prop="amount" width="150" />
			<el-table-column label="总人数" prop="name" :show-overflow-tooltip="true" />
			...
			<el-table-column label="操作" width="200" fixed="right">
				<template slot-scope="scope">
					<el-button type="primary" class="tb-button" icon="el-icon-edit" @click="handleEdit(scope.row)" v-hasPermi="['channel_product:save2:edit']" plain>编辑</el-button>
			...
			<el-form ref="form" :model="form" :rules="rules" label-width="100px">
				<el-row>
					...
					<el-form-item label="总人数">
						<el-input-number v-model="form.name" :controls="false" class="w210px text-left" />
					</el-form-item>
