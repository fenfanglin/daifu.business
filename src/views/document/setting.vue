		...
		<el-dialog title="测试下单" :visible.sync="openDemo" width="400px" append-to-body :close-on-click-modal="false">
			<el-form ref="form" :model="form" :rules="rules" label-width="0">
				...
				<el-row>
					...
					<el-form-item label="">
						<el-input v-model="form.amount" type="number" placeholder="请输入金额" autocomplete="off" @change="changeAmount" />
					</el-form-item>
					<div v-if="form.account_type ===2">
						<el-form-item label="">
							<el-input v-model="form.usdt_amount" placeholder="USDT金额" autocomplete="off" disabled />
							<p style="margin-top: 0;margin-bottom: -20px"> 换算汇率约为 <span class="text-danger">{{ usdt_rate }}</span> 资料由 OKX 提供</p>
						</el-form-item>
					</div>
					<el-form-item label="">
