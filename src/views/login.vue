		...
		<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
			...
			<el-form-item prop="username">
				<el-input
					...
					placeholder="账号"
				>
					<i slot="prefix" class="iconfont icon-user-outlined" />
				</el-input>
			</el-form-item>
			...
			<el-form-item prop="code" v-if="captchaOnOff">
				<el-input
					...
					@keyup.enter.native="handleLogin"
				>
					<i slot="prefix" class="iconfont icon-anquan1" />
				</el-input>
...
.login {
	...
	align-items: center;
	height: 100%;
	background-image: url("../assets/images/login_bg8.png");
	background-size: 100%;
