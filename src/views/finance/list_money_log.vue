<template>
	<div class="app-container">
		...
		<el-table ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list">
			<el-table-column label="ID" prop="id" fixed="left" min-width="15%" />
			...
			<el-table-column label="发生前金额" prop="money_before" min-width="20%" />
			<el-table-column label="发生后金额" prop="money_after" min-width="20%" />
...
<script>
export default {
	name: "finance_list_money_log", // 路由上 '/' 换成 '_'
	data() {
		return {
			user: {},
			// 遮罩层
